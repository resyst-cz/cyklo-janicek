...
if (isset($_POST['sbutton'])) {
    ...
    if ($captcha_req == 1) {
        ...
        // Enter a subject, only you will see this so make it useful
        $subject = $_SERVER['HTTP_HOST'] . ' - kontaktní formulář';
            ...
            <div class="control-group">
                ...
                if ($params->get('subject_publish')) {
                    ...
                    <div class="span7 predmet">
                        <input class="input-80" name="type" type="text" id="inputType" placeholder="<?php echo $params->get('fofield_name'); ?>">
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="span7">
                    <textarea class="input-80" name="message" rows="12" id="inputMessage" placeholder="<?php echo $params->get('fifield_name'); ?>" required></textarea>
                </div>
            </div>
            <?php
            ...
            if ($params->get('admin_email')) {
                ...
                <div class="control-group">
                    <div class="text-right">
                        <button type="submit" name="sbutton" value="Send" class="btn btn-primary"><?php echo $params->get('bs_name'); ?></button>
                    </div>
                </div>
                <?php
            } else {
