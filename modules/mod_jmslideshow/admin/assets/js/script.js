...
jQuery(document).ready(function(){
  ...
  JMSlideShow_ReadMoreChange(jQuery('#jform_params_jmslideshow_show_readmore').is(":checked"));
  ...
  JMSlideShow_PagertypeChange(jQuery('#jform_params_jmslideshow_pager_type').val());
  ...
  jQuery('#jform_params_jmslideshow_pager_type').change(function(){
	    JMSlideShow_PagertypeChange(jQuery(this).val());
  });
})
function JMSlideShow_SourceChange(source){
  jQuery(".s1, .s2, .s3, .s4, .s5, .s6, .s7, .s8, .s9, .s10").not(".s"+source).parents('li').css({
    display:'none'
  });
...
//Page Type
function JMSlideShow_PagertypeChange(source){
	switch(source){
    	case '1':
    		jQuery('#jform_params_jmslideshow_image_thumbnail_width').parent().css({
    	        display:'none'
    	    });
    		jQuery('#jform_params_jmslideshow_image_thumbnail_height').parent().css({
    	        display:'none'
    	    });
    		break;
    	case '2':
...
function JMSlideShow_title_toggle(){
  if(jQuery('#jform_params_jmslideshow_show_title').is(":checked")){
...
function JMSlideShow_desc_toggle(){
  if(jQuery('#jform_params_jmslideshow_show_desc').is(":checked")){
