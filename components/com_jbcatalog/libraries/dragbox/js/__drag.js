...
jElement.prototype.renderTooltipContent = function() {
    ...
    jQuery('#tabmargin').css('display','none');
    if(jQuery('#tablabel').length){
        jQuery('#tablabel').css('display','none');
    }
    jQuery('.on_tab:first').addClass('ui-tabs-active ui-state-active');
    if(jQuery('#tabtext').length){
        jQuery('#tabtext').css('display','block');
    }else{
        jQuery('#tabimage').css('display','block');
    }
    jQuery('.on_tab').click(function(){
           ...
           if(this.children[0].id == '#tabtext'){
                ...
                if(jQuery('#tablabel').length){
                    jQuery('#tablabel').css('display','none');
                    jQuery('.on_tab').eq(-2).removeClass('ui-tabs-active ui-state-active');
                }
                jQuery('#tabtext').css('display','block');
                this.addClass('ui-tabs-active ui-state-active');
                jQuery('.on_tab:last').removeClass('ui-tabs-active ui-state-active');
                ...
                if(jQuery('#tabtext').length){jQuery('#tabtext').css('display','none');
                    if(jQuery('#tablabel').length){
                        jQuery('#tablabel').css('display','none');
                    }
                }else{
                    jQuery('#tabimage').css('display','none');
                }jQuery('#tabmargin').css('display','block');
                this.addClass('ui-tabs-active ui-state-active');
                jQuery('.on_tab:first').removeClass('ui-tabs-active ui-state-active');}
                else if(this.children[0].id == '#tablabel'){
				jQuery('#tabmargin').css('display','none');
                                jQuery('#tabtext').css('display','none');
                                jQuery('#tablabel').css('display','block');
                                this.addClass('ui-tabs-active ui-state-active');
                                jQuery('.on_tab:last').removeClass('ui-tabs-active ui-state-active');
                                jQuery('.on_tab:first').removeClass('ui-tabs-active ui-state-active');
                }
