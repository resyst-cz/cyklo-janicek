...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null)
    {
        $this->options = [
            ...
            'upload_url' => dirname($this->get_server_var('SCRIPT_FILENAME')) . "/../../../../../../images/files/",
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function get_full_url($forUpload = false)
    {
        ...
        if ($forUpload) {
            return $url . 'images/files';
        }

        return $url . substr($_SERVER['SCRIPT_NAME'], 0, strrpos($_SERVER['SCRIPT_NAME'], '/'));
    }
