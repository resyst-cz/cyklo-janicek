...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
    <head>
        ...
        <link rel="mask-icon" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/favicons/safari-pinned-tab.svg" color="#ffffff"/>
    ...
    ?>">
        ...
        <!-- Google Tag Manager -->
        <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-NNSQV8"
        ...
        <div class="body">
                ...
                <div class="body-top">
                    <div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
                        <div class="row-fluid">
                            ...
                            <div class="fb-like span2" data-href="https://www.facebook.com/cyklo.janicek" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="span4">
                                <header class="header" role="banner">
                                    <div class="header-inner clearfix">
                                        <a class="brand pull-left" href="<?php echo $this->baseurl; ?>/"><?php echo $logo; ?></a>
                                    </div>
                                </header>
                            </div>
                            <div class="span8">
            ...
            <div class="spodni-lista">
                <div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
                    <div class="row">
                        <div class="span6 lista-icon-form">

                            <div id="mc_embed_signup">
                                <form action="//cyklo-janicek.us11.list-manage.com/subscribe/post?u=393e02a511c53b896838194b7&amp;id=70eec484f7" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                    <div id="mc_embed_signup_scroll">
                                        <label class="lista-title" for="mce-EMAIL">Přihlášení do newsletteru</label>
                                        <div class="lista-text">
                                            <input type="email" value="" name="EMAIL" class="email form-control" id="mce-EMAIL" placeholder="emailová adresa" required>
                                                <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                                                <div style="position: absolute; left: -5000px;"><input type="text" name="b_393e02a511c53b896838194b7_70eec484f7" tabindex="-1" value=""></div>
                                                <div class="clear" style="margin-top: -35px;  margin-left: 224px;"><input type="submit" value="Přihlásit se" name="subscribe" id="mc-embedded-subscribe" class="btn btn-newsletter"></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <!-- <div class="lista-title">Přihlášení do newsletteru</div>
                            <div class="lista-text">
                                <input type="email" placeholder="zadejte@vas.email" class="form-control">
                                <button class="btn btn-newsletter">Přihlásit se</button>
                            </div> -->
                        </div>
                        <div class="span6 lista-icon-phone">
        ...
        <footer class="footer" role="contentinfo">
            <div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
                <div class="row">
                    ...
                    <div class="footer-module span4">
                        <h3>Sledujte nás</h3>
                        <div class="fb-page" data-href="https://www.facebook.com/cyklo.janicek" data-width="288" data-height="227" data-hide-cover="true" data-show-facepile="true" data-show-posts="false">
                ...
                <div class="row margin-top">
                    ...
                    <p class="span4">
                        <a class="fb-icon" href="https://www.facebook.com/cyklo.janicek" data-placement="top" data-toggle="tooltip" data-original-title="Cyklo Janíček na Facebooku"><img src="images/footer_ikonky/icon_fb.png" alt="Cyklo Janíček na Facebooku" /></a>
                        <a class="ig-icon" href="https://www.instagram.com/cyklo.janicek" data-placement="top" data-toggle="tooltip" data-original-title="Cyklo Janíček na Instagramu"><img src="images/footer_ikonky/icon_instagram.png" alt="Cyklo Janíček na Instagramu" /></a>
