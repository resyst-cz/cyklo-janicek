...
if ($jquery_cycle_load != 1) {
  print '<script type="text/javascript" src="' . JURI::base(true) . '/modules/mod_jmslideshow/assets/js/jquery.cycle2.js"></script>';
  $jquery_cycle_load = 1;
}
...
$caption_css_bottom="left:{$jm_caption_left}px;";
$caption_css_bottom.="bottom:{$jm_caption_bottom}px";
...
<div id="jmslideshow-<?php print $module->id; ?>"
     ...
     <?php endif;?>
      <?php if($jmslideshow_pager_type == 3):?>
     data-cycle-pager-template="<span><a href=#> <img class='jmslide-thumb-img' src='{{slidethumb}}'/> </a></span>"
     <?php endif;?>
     >
    ...
    <?php foreach ($slides as $slide): ?>
       <?php if($slide->image): ?>
	      <div class="jmslide-item">
	       <a href="<?php print $slide->link; ?>"> <img title="<?php print $slide->getThumbnail();?>" class="jmslide-img" src="<?php print $slide->getMainImage(); ?>"/></a>
  ...
  <?php if ($jm_show_pager): ?>
    ...
    <div class="cycle-pager<?php if ($jmslideshow_pager_hidden_mobile) print " jmhidden-mobile"; ?><?php if($jmslideshow_pager_type ==2) print " pager-number";?> <?php if($jmslideshow_pager_type == 3) print " pager-thumbnail"; ?>" style="<?php print $pager_css; ?>"></div>
   
  <?php endif; ?>
  <?php if ($jm_show_nav_buttons): ?>
    <a href="#" class="cycle-prev<?php if ($jmslideshow_control_hidden_mobile) print " jmhidden-mobile"; ?>"><span>Předchozí</span></a>
    <a href="#" class="cycle-next<?php if ($jmslideshow_control_hidden_mobile) print " jmhidden-mobile"; ?>"><span>Další</span></a>
  <?php endif; ?>
</div>