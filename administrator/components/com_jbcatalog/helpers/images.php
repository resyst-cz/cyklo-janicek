...
class ImagesHelper
{
	public static function loaderUI($vals, $multi = true){
            ...
            <noscript><link rel="stylesheet" href="../components/com_jbcatalog/libraries/jsupload/css/jquery.fileupload-ui-noscript.css"></noscript>
                                     ...
                                     <tr class="template-download fade in">
                                        <td>
                                            <span class="preview">
                                                ...
                                                <a href="../components/com_jbcatalog/libraries/jsupload/server/php/files/<?php echo $val?>" title="<?php echo $val?>" download="<?php echo $val?>" data-gallery=""><img src="../components/com_jbcatalog/libraries/jsupload/server/php/files/thumbnail/<?php echo $val?>"></a>

                                            </span>
                                        </td>
                                        <td>
                                            <p class="name">
                                                <a href="../components/com_jbcatalog/libraries/jsupload/server/php/files/<?php echo $val?>" title="<?php echo $val?>" download="<?php echo $val?>" data-gallery=""><?php echo $val?></a>
                                        ...
                                        <td>
                                            <span class="size">
                                                <?php echo ImagesHelper::filesize_get("../components/com_jbcatalog/libraries/jsupload/server/php/files/".$val)?>
                                            </span>
                                        </td>
                                        <td>
                                            <button class="btn btn-danger delete" data-type="DELETE" data-url="../components/com_jbcatalog/libraries/jsupload/server/php/?file=<?php echo $val?>">
                                                <i class="icon-trash icon-white"></i>
                                                <span>Smazat</span>
                                            </button>
